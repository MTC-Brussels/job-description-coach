...
export default async function handler(
  ...
  const response = await openai.createCompletion({
    ...
    temperature: 0,
    prompt: `
I want you to assess the job title, the responsibilities, Accuracy of human skills, Inclusiveness (degree), accuracy of technical skills, Inclusiveness (language), transparency, and attractiveness of a job description. Could you help me to rate the following 8 points ?
...
Finish with 2 or 3 recommendations with bullet points for each of the following categories: the job title, Accuracy of human skills, Inclusiveness (degree), the accuracy of technical skills, Inclusiveness (language), transparency, and attractiveness of the job description.
...
If the overall score is less than 49%, advise not to post at the end.
If the overall score is between 50% and 69%, advise redoing the job desc and test again.

If the overall score is between 70% and 90%, advise fixing the easy points.
